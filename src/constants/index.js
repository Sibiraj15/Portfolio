...
export const HERO_CONTENT = `I am a passionate beginner full-stack developer eager to build scalable and user-friendly web applications. With 3 months of internship experience, I have developed a strong foundation in HTML, CSS, JavaScript, React, Next.js, Node.js, MySQL, and MongoDB. I love learning new technologies and solving problems through code, aiming to create efficient and impactful digital solutions.`;

export const ABOUT_TEXT = `I am a dedicated and versatile full stack developer with a passion for creating efficient and user-friendly web applications.  With 3 months of internship experience, I have worked with a variety of technologies, including React, Next.js, Node.js, MySQL, and MongoDB. My journey in web development began with a deep curiosity for how things work, and it has evolved into a career where I continuously strive to learn and adapt to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. Outside of coding, I enjoy staying active, exploring new technologies, and contributing to open-source projects.`;

export const EXPERIENCES = [
  {
   title: "React Developer Intern – Netkathir Technologies (3 Months)",
...
export const EDUCATION =[
  {
    title: "SSLC",
    academy: "Fatima Matric Higher Secondary School",
    year: "2017-2018",
    cpga: "59.6%",
  ...
  {
    title: "Undergraduate",
    academy: "Prince Shri Venkadeshwara Arts and Science College",
    year: "2020-2023",
    cpga: "88.8%",
  ...
  {
    title: "Postgraduate ",
    academy: "Christ College of Engineering And Technology",
    year: "2023-2025",
    cpga: "84.5%",
...
export const PROJECTS = [
  ...
  },
  {
    ...
    image: project4,
    description:
      "A Car Rental Management System simplifies booking, tracking, and managing rental vehicles, ensuring a seamless experience for customers and businesses. 🚗",
